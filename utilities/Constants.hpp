...
const RGBColor yellow      = {1.0f, 1.0f, 0.0f};
const RGBColor brown       = {0.71f, 0.40f, 0.16f};
const RGBColor darkGreen   = {0.0f, 0.41f, 0.41f};
const RGBColor orange      = {1.0f, 0.75f, 0.0f};
const RGBColor lightGreen  = {0.65f, 1.0f, 0.30f};
const RGBColor darkYellow  = {0.61f, 0.61f, 0.0f};
const RGBColor lightPurple = {0.65f, 0.3f, 1.0f};
const RGBColor darkPurple  = {0.5f, 0.0f, 1.0f};

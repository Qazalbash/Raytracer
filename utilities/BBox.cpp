 ...
 * @return std::string
 */
std::string BBox::to_string() const { return this->pmin.to_string() + " " + this->pmax.to_string(); }
 ...
 * @return false
 */
bool BBox::overlaps(const Geometry* g) const {
 ...
 * @return false
 */
bool BBox::overlaps(const BBox& b) const { return (pmax.x > b.pmin.x && pmax.y > b.pmin.y && pmax.z > b.pmin.z); };
